...
let MOCK_EMAILS = [
  {
    ...
    sender: 'Jio NOC Team',
    operator: 'Jio',
    subject: '[SR] New Site SP Request – MH-MUM-0234 | Malad West',
...
Airtel Infrastructure Operations`,
  ...
  },
  {
    id: 'E003',
    from: 'rfi@vi.in',
    sender: 'Vi Network Planning',
    operator: 'Vi',
    subject: 'RFI Response – Site MH-NGP-0134 | Power Details Clarification',
    time: '2026-05-26 08:15',
    priority: 'medium',
    unread: true,
    body: `Dear Team,

In response to your RFI#TCI-RFI-2026-0183, please find requested clarification:

RFI Ref        : TCI-RFI-2026-0183
Site ID        : MH-NGP-0134
Circle         : Maharashtra – Nagpur

Clarification Points:
1. Power Source: EB (State Electricity) + Solar Backup (5kW)
2. DG Capacity: 15 kVA (Tier 2)
3. Load Shedding Zone: Zone B (6 hrs/day avg)
4. Generator Run Hours: 8-10 hrs/day peak season

Battery Bank: 48V / 500Ah VRLA
Solar Panel Count: 20 panels (250W each)
Grid Tariff: ₹7.50/kWh (commercial)

Regards,
Vi Network Planning Team`,
    extracted: {
      rfiRef: { val: 'TCI-RFI-2026-0183', conf: 99 },
      siteId: { val: 'MH-NGP-0134', conf: 98 },
      circle: { val: 'Maharashtra – Nagpur', conf: 97 },
      operator: { val: 'Vi', conf: 99 },
      powerSource: { val: 'EB + Solar Backup (5kW)', conf: 96 },
      dgCapacity: { val: '15 kVA', conf: 95 },
      batteryBank: { val: '48V / 500Ah VRLA', conf: 94 },
      requestType: { val: 'RFI Response', conf: 98 }
    },
    srType: 'RFI'
  },
  {
    ...
    operator: 'BSNL',
    subject: '[URGENT] SP Required – DL-DEL-0045 | Connaught Place',
    time: '2026-05-26 07:52',
    priority: 'high',
    unread: true,
    body: `Greetings,

This is an urgent request for SP creation for our new site:

Site ID        : DL-DEL-0045
Tower Code     : BSNL-DEL-RT-0045
Circle         : Delhi
Site Type      : Rooftop Tower (RoT)
Antenna Height : 15 meters (above terrace)
Tenant Count   : 2 (BSNL + Sharing)
Power Source   : EB only
Earthing Type  : IS 3043 / TAIPA Standard
Latitude       : 28.6315° N
Longitude      : 77.2194° E
District       : New Delhi
Pincode        : 110001

SLA: P1 – 4 Hours (URGENT – NOC escalation)
Ticket: BSNL-NOC-2026-0889

This requires immediate action as site is scheduled for commissioning in 48 hours.`,
    extracted: {
      ...
      latitude: { val: '28.6315° N', conf: 99 },
      longitude: { val: '77.2194° E', conf: 99 },
      slaClass: { val: 'P1 – 4 Hours (URGENT)', conf: 98 },
      requestType: { val: 'SP Creation', conf: 99 }
    },
    srType: 'SP'
  },
  {
    ...
    sender: 'Jio NOC Desk',
    operator: 'Jio',
    subject: 'SO Ingest + RFI – GJ-AHM-0312 | Tower Sharing Config',
    time: '2026-05-25 18:30',
    priority: 'medium',
    unread: false,
    body: `Hi Team,

Combined SO & RFI for Gujarat – Ahmedabad site:
...
RFI Required:
- Please confirm load bearing capacity calculations for additional tenant
- Structural audit report status?
- SHR (Structural Health Report) validity?
...
Regards, Jio NOC`,
    extracted: {
      ...
      operator: { val: 'Jio', conf: 99 },
      sharingConfig: { val: '3-tenant (Jio+Airtel+Vi)', conf: 94 },
      rfiRequired: { val: 'Yes – Structural Data', conf: 92 },
      requestType: { val: 'SO + RFI', conf: 96 }
    },
    srType: 'SO'
  },
  {
    id: 'E006',
    from: 'infra@bhartiairtel.com',
    sender: 'Airtel Infrastructure',
    operator: 'Airtel',
    subject: 'Monthly SR Summary Report – May 2026',
    time: '2026-05-25 17:00',
    priority: 'low',
    unread: false,
    body: `Dear Partner,

Please find attached the monthly summary of all service requests raised in May 2026.
...
Top Circles: Maharashtra, Karnataka, Tamil Nadu
SLA Compliance    : 96.2%

Regards,
Airtel Infrastructure Team`,
    extracted: {
      reportType: { val: 'Monthly SR Summary', conf: 99 },
      period: { val: 'May 2026', conf: 99 },
      totalSRs: { val: '48', conf: 99 },
      slaCompliance: { val: '96.2%', conf: 98 },
      requestType: { val: 'Informational', conf: 95 }
    },
    srType: 'INFO'
  },
  {
    id: 'E007',
    from: 'noc@vi.in',
    sender: 'Vi NOC Operations',
    operator: 'Vi',
    subject: '[SR] SP Creation – KA-BLR-0567 | Electronic City Phase 2',
    time: '2026-05-25 14:22',
    priority: 'medium',
    unread: true,
    body: `Dear TowerCo,

New SP creation request for Bengaluru site:

Site ID        : KA-BLR-0567
Tower Code     : VI-BLR-GMT-0567
Circle         : Karnataka – Bengaluru
Site Type      : Ground Mounted Tower
...
Missing Info:
- RoW Approval Number (awaited from BBMP)
- Structural Report (to be uploaded by site team)

SLA: P2 – 8 Hours
Ticket: VI-NOC-2026-0412

Regards, Vi Network Planning`,
    extracted: {
      siteId: { val: 'KA-BLR-0567', conf: 98 },
      towerCode: { val: 'VI-BLR-GMT-0567', conf: 96 },
      circle: { val: 'Karnataka – Bengaluru', conf: 97 },
      operator: { val: 'Vi', conf: 99 },
      latitude: { val: '12.8352° N', conf: 99 },
      longitude: { val: '77.6635° E', conf: 99 },
      missingFields: { val: 'RoW Number, Structural Report', conf: 91 },
      requestType: { val: 'SP Creation', conf: 98 }
    },
    srType: 'SP'
  }
];
...
function navigateTo(view) {
  ...
  const breadcrumbs = {
    ...
    'rfi-recieval': 'RFI Recieval – Ready for Installation',
  ...
  list.innerHTML = MOCK_EMAILS.map(em => `
    <div class="email-item ${em.unread ? 'unread' : ''}" data-id="${em.id}">
      ...
      <div class="email-meta" style="margin-top:4px">
        ...
        <span class="priority-tag ${em.priority}">${em.priority}</span>
      </div>
    </div>`).join('');
...
function initRunAIBtn() {
  document.getElementById('run-ai-btn').addEventListener('click', () => {
    showAIOverlay('Processing all unread emails with AI engine...', () => {
      showToast('✓ AI processed 5 emails | 4 SRs created | 1 RFI auto-drafted');
    });
  });
}
...
function renderSRCard(sr) {
  ...
  return `
    <div class="sr-card" onclick="showToast('SR ${sr.id} – ${sr.site}')">
      ...
      <div class="sp-form-container-grid">
        <div class="sp-form-left-col">
          ...
          <div class="form-actions" style="margin-top:10px">
            <button class="btn-lg primary" onclick="showToast('✓ SP submitted for ${srId} | IT system update initiated')">
...
// ===================================================
// RFI RECIEVAL (READY FOR INSTALLATION)
// ===================================================
...
const BIHAR_EMAILS = [
  {
    ...
    operator: 'Jio',
    subject: '[SR] New Site SP Request – BR-PAT-0234 | Patna West',
    time: '2026-05-26 09:14',
    priority: 'high',
    unread: true,
    body: `Dear Tower Co Team,
...
Airtel Gaya Infrastructure`,
  ...
  {
    id: 'E003',
    from: 'rfi-bihar@vi.in',
    sender: 'Vi Bihar Planning',
    operator: 'Vi',
    subject: 'RFI Response – Site BR-MZF-0134 | Power Details Muzaffarpur',
    time: '2026-05-26 08:15',
    priority: 'medium',
    unread: true,
    body: `Dear Team,

In response to your RFI#TCI-RFI-2026-0211, please find requested clarification for Muzaffarpur site:

RFI Ref        : TCI-RFI-2026-0211
Site ID        : BR-MZF-0134
Circle         : Bihar – Muzaffarpur

Clarification Points:
1. Power Source: EB (State Electricity) + DG Backup
2. DG Capacity: 15 kVA (Tier 2)
3. Load Shedding Zone: Zone C (8 hrs/day avg)

Battery Bank: 48V / 400Ah VRLA

Regards,
Vi Bihar Network Planning`,
    extracted: {
      rfiRef: { val: 'TCI-RFI-2026-0211', conf: 99 },
      siteId: { val: 'BR-MZF-0134', conf: 98 },
      circle: { val: 'Bihar – Muzaffarpur', conf: 97 },
      operator: { val: 'Vi', conf: 99 },
      powerSource: { val: 'EB + DG (Backup)', conf: 96 },
      dgCapacity: { val: '15 kVA', conf: 95 },
      batteryBank: { val: '48V / 400Ah VRLA', conf: 94 },
      requestType: { val: 'RFI Response', conf: 98 }
    },
    srType: 'RFI'
  },
  {
    ...
    operator: 'BSNL',
    subject: '[URGENT] SP Required – BR-BGP-0045 | Bhagalpur Town',
    time: '2026-05-26 07:52',
    priority: 'high',
    unread: true,
    body: `Greetings,

This is an urgent request for SP creation for our new Bhagalpur site:
...
SLA: P1 – 4 Hours (Escalation threat)
Ticket: BSNL-BR-2026-9908

This is required immediately as deployment is scheduled in 24 hours.`,
    extracted: {
      ...
      latitude: { val: '25.2425° N', conf: 99 },
      longitude: { val: '86.9842° E', conf: 99 },
      slaClass: { val: 'P1 – 4 Hours', conf: 98 },
      requestType: { val: 'SP Creation', conf: 99 }
    },
    srType: 'SP'
  },
  {
    ...
    operator: 'Jio',
    subject: 'SO Ingest + RFI – BR-DBG-0312 | Darbhanga sharing',
    time: '2026-05-25 18:30',
    priority: 'medium',
    unread: false,
    body: `Hi Team,

Combined SO & RFI for Bihar – Darbhanga site:
...
RFI Required:
- Structural Audit report for additional operator antenna config?
- Structural audit report status?
...
Regards, Jio Bihar NOC`,
    extracted: {
      ...
      operator: { val: 'Jio', conf: 99 },
      sharingConfig: { val: '2-tenant (Jio+Airtel)', conf: 94 },
      rfiRequired: { val: 'Yes – Structural Data', conf: 92 },
      requestType: { val: 'SO + RFI', conf: 96 }
    },
    srType: 'SO'
  },
  {
    ...
    sender: 'Vi Patna Operations',
    operator: 'Vi',
    subject: '[SR] SP Creation – BR-PUR-0567 | Purnia Bypass',
    time: '2026-05-25 14:22',
    priority: 'medium',
    unread: true,
    body: `Dear TowerCo,

New SP creation request for Purnia site:

Site ID        : BR-PUR-0567
Tower Code     : VI-BR-PUR-0567
Circle         : Bihar – Purnia
Site Type      : Guyed Mast
Tower Height   : 36 meters
Latitude       : 25.7771° N
Longitude      : 87.4752° E
Power Source   : EB only
...
Missing Info:
- RoW Approval Number (Awaited from Local Municipal Board)

SLA: P2 – 8 Hours
Ticket: VI-BR-2026-0122

Regards, Vi Patna Network Planning`,
    extracted: {
      siteId: { val: 'BR-PUR-0567', conf: 98 },
      towerCode: { val: 'VI-BR-PUR-0567', conf: 96 },
      circle: { val: 'Bihar – Purnia', conf: 97 },
      operator: { val: 'Vi', conf: 99 },
      latitude: { val: '25.7771° N', conf: 99 },
      longitude: { val: '87.4752° E', conf: 99 },
      missingFields: { val: 'RoW Number', conf: 91 },
      requestType: { val: 'SP Creation', conf: 98 }
    },
    srType: 'SP'
  }
